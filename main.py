...
async def home():
    return HTMLResponse("""
    <h1 style="text-align:center;color:#00C4B4;margin-top:100px">Quick Click Repairs Booking</h1>
    <p style="text-align:center;font-size:24px"><a href="/admin">Go to Admin Dashboard</a></p>
    """)
...
async def admin():
    ...
    <div style="background:#1e1e1e;color:#e0e0e0;padding:20px;min-height:100vh">
      ...
      <h2 style="text-align:center;margin-top:40px">REMINDERS</h2>
...
async def new_checkin():
    return HTMLResponse("""
    <div style="max-width:600px;margin:auto;background:#2a2a2a;padding:40px;border-radius:15px;color:#e0e0e0">
      <h1 style="text-align:center;color:#00C4B4;margin-bottom:30px">+ New Check In</h1>
...
async def new_invoice():
    return HTMLResponse("""
    <div style="max-width:600px;margin:auto;background:#2a2a2a;padding:40px;border-radius:15px;color:#e0e0e0">
      <h1 style="text-align:center;color:#00C4B4;margin-bottom:30px">+ New Invoice</h1>
...
async def new_estimate():
    return HTMLResponse("""
    <div style="max-width:600px;margin:auto;background:#2a2a2a;padding:40px;border-radius:15px;color:#e0e0e0">
      <h1 style="text-align:center;color:#00C4B4;margin-bottom:30px">+ New Estimate</h1>
